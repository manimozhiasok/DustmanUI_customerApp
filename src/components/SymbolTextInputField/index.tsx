...
export const SymbolTextInputField = ({ valueLeft, valueRight, leftIsIcon }: { valueLeft: any, valueRight: string, leftIsIcon?: boolean }) => {
  ...
  return (
    <TextInputComponent         
          ...
          InputProps={{
            startAdornment: <InputAdornment position="start" disableTypography = {true} className={classes.priceSignContainer} >
