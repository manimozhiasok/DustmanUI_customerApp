...
import BookYourPickup from 'src/dutmanui/content/BookYourPickup';
import Profile from 'src/dutmanui/content/Profile';
import OrdersPages from 'src/dutmanui/content/OrdersPage';
import {
  BookYourPageImage,
  RoundPattern,
  DottedPattern
